...
async function getShopOwnerUser(userId) {
...
async function ensureUniquePhone(phone, userId) {
  if (!phone) {
    return
  }
...
async function ensureUniqueGstNumber(gstNumber, profileId) {
  if (!gstNumber) {
    return
  }
...
async function generateUniqueShopSlug(name, excludeShopId) {
...
async function getShopOwnerProfile(userId) {
...
async function updateShopOwnerProfile(userId, payload) {
...
async function createShop(userId, payload) {
  const user = await getShopOwnerUser(userId)
...
async function listShopOwnerShops(userId) {
  const user = await getShopOwnerUser(userId)
...
async function getShopOwnerShop(userId, shopId) {
  const user = await getShopOwnerUser(userId)
